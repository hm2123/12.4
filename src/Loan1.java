public class Loan1 {
    ...
    public Loan1(double annualInterestRate, int numberOfYears,
                double loanAmount) {
        if (loanAmount <= 0)
            throw new IllegalArgumentException("The amount of the loan must be greater than 0.");
        if (annualInterestRate <= 0)
            throw new IllegalArgumentException("The interest rate  must be greater than 0.");
        if (numberOfYears <= 0)
            throw new IllegalArgumentException("The number of years must be greater than 0.");
